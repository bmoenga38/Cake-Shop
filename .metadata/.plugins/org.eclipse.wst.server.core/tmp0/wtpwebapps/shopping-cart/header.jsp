...
<%@ page import="com.cake.service.impl.*,com.cake.service.*"%>
...
<body style="background-color: #E6F9E6;">
	...
	<div class="container-fluid text-center"
		style="margin-top: 45px; background-color: #733adc; color: white; padding: 5px;">
		<h2>John's E-Shop</h2>
		<h6>Cakes and pastries</h6>
		...
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.jsp"><span
					class="glyphicon glyphicon-home">&nbsp;</span>CAKE Center</a>
			</div>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="index.jsp?type=BirthDay">Birth Day</a></li>
							<li><a href="index.jsp?type=Wedding">Wedding</a></li>
							<li><a href="index.jsp?type=Party">Party</a></li>
							<li><a href="index.jsp?type=Anniversary">Anniversary</a></li>
							<li><a href="index.jsp?type=Promotion">Promotion</a></li>
							<li><a href="index.jsp?type=Graduation">Graduation</a></li>
						</ul></li>
				</ul>
			</div>
		</div>
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav navbar-right">
					...
					<li class="dropdown"><a class="dropdown-toggle"
						...
						<ul class="dropdown-menu">
							<li><a href="adminViewProduct.jsp?type=BirthDay">Birth Day</a></li>
							<li><a href="adminViewProduct.jsp?type=Wedding">Wedding</a></li>
							<li><a href="adminViewProduct.jsp?type=Party">Party</a></li>
							<li><a href="adminViewProduct.jsp?type=Anniversary">Anniversary</a></li>
							<li><a href="adminViewProduct.jsp?type=Graduation">Promotion</a></li>
							<li><a href="adminViewProduct.jsp?type=Graduation">Graduation</a></li>
						</ul></li>
