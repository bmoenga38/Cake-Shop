...
<%@ page
	import="com.cake.service.impl.*,com.cake.service.*,com.cake.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="BirthDay"
								<%="BirthDay".equalsIgnoreCase(ptype) ? "selected" : ""%>>Birth Day</option>
							<option value="tv"
								<%="Wedding".equalsIgnoreCase(ptype) ? "selected" : ""%>>Wedding</option>
							<option value="Wedding"
								<%="Party".equalsIgnoreCase(ptype) ? "selected" : ""%>>Party</option>
							<option value="Party"
								<%="Anniversary".equalsIgnoreCase(ptype) ? "selected" : ""%>>Anniversary</option>
							<option value="Anniversary"
								<%="Promotions".equalsIgnoreCase(ptype) ? "selected" : ""%>>Promotions</option>
							<option value="Promotions"
								<%="Graduation".equalsIgnoreCase(ptype) ? "selected" : ""%>>Graduation</option>
							<option value="other"
								<%="other".equalsIgnoreCase(ptype) ? "selected" : ""%>>Other</option>
						</select>
					</div>
				</div>
				<div class="form-group">
